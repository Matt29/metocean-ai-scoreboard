...
Généré par `pipeline/scripts/train.py` le 2026-08-04 14:09 UTC (test = les 365 derniers jours d'émission).
...
|---|---|---|---|---|---|---|---|---|---|---|
| brest | tide | harmonique | `hgb-per-lead` | 24600 / 17484 | 0.119 | 0.119 | 0.056 | +52.7% | **+52.9%** | PASS |
| saint-malo | tide | harmonique | `hgb-per-lead` | 26112 / 17484 | 0.155 | 0.155 | 0.106 | +31.4% | **+31.5%** | PASS |
...
|---|---|---|---|---|---|---|
| brest | décile sup. | 1750 | 0.332 | 0.327 | 0.080 | **+75.6%** |
| brest | |résidu| > 30 cm | 890 | 0.390 | 0.384 | 0.085 | **+77.9%** |
| saint-malo | décile sup. | 1750 | 0.420 | 0.417 | 0.190 | **+54.6%** |
| saint-malo | |résidu| > 30 cm | 2182 | 0.398 | 0.396 | 0.180 | **+54.6%** |
...
|---|---|---|---|---|---|
| brest | tide | +4.9% | +7.3% | **+7.5%** | `hgb-per-lead` |
| saint-malo | tide | +5.8% | +0.7% | **+8.2%** | `hgb-per-lead` |
...
4. **Sur 0 des 2 stations ré-entraînées, plus de la
   ...
   * `brest` : biais +0.010 m — gain affiché +52.7%, **hors biais +52.9%**
   * `saint-malo` : biais +0.013 m — gain affiché +31.4%, **hors biais +31.5%**
